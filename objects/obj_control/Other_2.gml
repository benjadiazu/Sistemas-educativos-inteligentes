...
if (!instance_exists(obj_control)) {
    instance_deactivate_object(self); // Evitar duplicados si se marca persistente en otras salas
    persistent = true;                // Marca el objeto como persistente
}
